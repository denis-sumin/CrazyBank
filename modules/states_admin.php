...
$modules[$module]['name'] = 'Управление партиями'; // человеческое название модуля

$modules[$module]['action'][] = 'admin_add_state';
$modules[$module]['menu'][] = 'Добавить партию';
$modules[$module]['title'][] = 'Новая партия';

$modules[$module]['action'][] = 'admin_edit_usersinstate';
$modules[$module]['menu'][] = 'Изменить список членов партии';
$modules[$module]['title'][] = 'Изменение списка членов партии';
